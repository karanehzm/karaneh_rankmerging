...
def main():
    ...
    "for karate_club:"
    "./Merge_learn 34 100 300 2 l3_learning_karate_club.txt,cra_learning_karate_club.txt ex_100k_karate_club"
    ...
    "./Merge_test 34 100 learning_ex_100k_karate_club.txt 1.22 2 l3_testing_karate_club.txt,cra_testing_karate_club.txt ex_t_100k_karate_club.txt"
    "-------------------------------------------- inputs to the rankmerging --------------------------------------"
    # learning_file_1 = LEARNING_DIR / "cra_learning_karate_club.txt"
    # learning_file_2 = LEARNING_DIR / "l3_learning_karate_club.txt"
    # testing_file_1 = LEARNING_DIR / "cra_testing_karate_club.txt"
    # testing_file_2 = LEARNING_DIR / "l3_testing_karate_club.txt"
    # learning_files = [learning_file_1, learning_file_2]
    # testing_files = [testing_file_1, testing_file_2]
    # s = compute_scaling_factor_multiple(learning_files, testing_files)
    # print(s)

    CRA_FILE = SCORES_DIR / f"cra_score_test_{DATASET_NAME}.txt"
    L3N_FILE = SCORES_DIR / f"l3_score_test_{DATASET_NAME}.txt"
    # CN_FILE = SCORES_DIR / f"cn_score_test_{DATASET_NAME}.txt"
    rankmerging_output = LEARNING_DIR/f"ranking_ex_t_10k_{DATASET_NAME}.txt"
    ...
    # sorted_cn = read_score_file_as_sorted_list(CN_FILE)
    ...
    my_tp_fp_L3Nf1 = tp_fp(sorted_l3n, test_set_ael, NUM_PREDICION, 100) 
    ...
    my_tp_fp_cra = tp_fp(sorted_cra, test_set_ael, NUM_PREDICION, 100)
    ...
    # my_tp_fp_cn = tp_fp(sorted_cn, test_set_ael, NUM_PREDICION, 500)
    # my_pr_rc_cn = pr_rc(my_tp_fp_cn[0], my_tp_fp_cn[1], my_num_edges)
    # to_store_cn = RESULT_DIR/f"cn_plot_100k_{DATASET_NAME}"
    # # # register_image (to_store_cn, my_pr_rc_cn[0], my_pr_rc_cn[1])
    
    my_tp_fp_rank = tp_fp_rank(rankmerging_output, TEST_DATASET, NUM_PREDICION, 100)
    ...
    # ("CN", my_tp_fp_cn[0], my_tp_fp_cn[1]),
...
#     graph = load_data(dataset_path)
#     edges = load_edges(dataset_path)
#     ael = el_to_ael(graph)
    
#     candidate_pairs = potential_edges_distance3_only(ael)
#     similarity_score(candidate_pairs, ael)
