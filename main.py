...
def main():
    ...
    "for karate_club:"
    "./Merge_learn 34 100000 300 2 l3_learning_karate_club.txt,cra_learning_karate_club.txt ex_100k_karate_club"
    ...
    my_pr_rc_cn = pr_rc(my_tp_fp_cn[0], my_tp_fp_cra[1], my_num_edges)
